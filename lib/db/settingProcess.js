    ...
    try {
        const result = await pool.request()
            .query('SELECT BILDIRIM_GONDERME_DENEME_SAYISI,KAC_DAKIKA_ONCEKI_BILDIRIM_GONDERILSIN,' +
                'NET_GSM_BIRINCI_FIRMA,TEK_SEFERDE_SMS_GONDERILECEK_KISI_SAYISI, ' +
                'TEK_SEFERDE_SESLI_CAGRI_GONDERILECEK_KISI_SAYISI,TEK_SEFERDE_MAIL_GONDERILECEK_KISI_SAYISI,' +
                'KOBICOM_BIRINCI_FIRMA,KIRMIZI_SANTRAL_BIRINCI_FIRMA,AKTIF_BIRINCI_FIRMA,AKTIF_IKINCI_FIRMA,' +
                'CAGRI_SONLANDIRMA_GERI_ARAMASI,CAGRI_SONLANDIRMA_ARAMA_BASLAMA_DAKIKASI, ' +
                'CAGRI_SONLANDIRMA_ARAMA_BITIS_DAKIKASI FROM K_DAHIKOD_AYARLAR')
        ...
        settings.kobicomBirinciFirma = dbSettings.KOBICOM_BIRINCI_FIRMA
        settings.kirmiziSantralBirinciFirma = dbSettings.KIRMIZI_SANTRAL_BIRINCI_FIRMA
        settings.aktifBirinciFirma = dbSettings.AKTIF_BIRINCI_FIRMA
        settings.aktifIkinciFirma = dbSettings.AKTIF_IKINCI_FIRMA
        settings.cagriOnayAramasiAktifligi= dbSettings. CAGRI_SONLANDIRMA_GERI_ARAMASI
        settings.cagriOnayAramasiKontrolDakikasiBaslangic= dbSettings.CAGRI_SONLANDIRMA_ARAMA_BASLAMA_DAKIKASI
        settings.cagriOnayAramasiKontrolDakikasiBitis= dbSettings.CAGRI_SONLANDIRMA_ARAMA_BITIS_DAKIKASI
    } catch (err) {
